...
class HomeController extends Controller
{
    public function send_mail(){
         //send mail
                $to_name = "Tran Dac Dinh";
                $to_email = "dinh.b6.namly.2012@gmail.com";//send to this email
    ...
    public function index(Request $request){
        ...
        //seo
        $meta_desc = "Chuyên bán những phụ kiện sản phẩm điện tử chất lượng nhất";
        $meta_keywords = "san pham game, sản phẩm game, sản phẩm game tốt";
        $meta_title = "My-Shop Shop bán hàng";
